...
public class DbPersonControl {
    ...
    public DbPersonControl() {
        connection = new Conection("Day10");
    ...
    public void insertPerson(Person person) {
        ...
        }else System.out.println("There is already a person with that DNI");
    }
    ...
    public void deletePerson(String Dni) {
        if(personExists(Dni)) {
            ...
            System.out.println("DNI Doesn't Exit");
    }
}